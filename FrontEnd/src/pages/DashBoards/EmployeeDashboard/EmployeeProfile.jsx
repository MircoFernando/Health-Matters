...
import { Pencil, Bell, Settings, User, Phone, ShieldAlert, Edit3 } from "lucide-react";
...
export const EmployeeProfile = () => {
  ...
  const DisplayField = ({ label, value, fullWidth = false }) => (
    <div className={fullWidth ? "md:col-span-2" : ""}>
      ...
      <div className="w-full bg-gray-50 rounded-2xl px-5 py-3.5 text-slate-700 font-semibold border border-transparent">
        {value}
      </div>
    </div>
  );
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-8 min-h-screen">
      ...
      <main className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          {/* PERSONAL INFO */}
          <section className="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100 group relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <DisplayField label="Full Name" value="John De Lavada" />
          ...
          <section className="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100 group relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <DisplayField label="Address" value="7th RD, Colombo" fullWidth={true} />
            </div>
          </section>
          ...
          <section className="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100 group relative">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-[#0F172A]">Emergency Contact</h2>
              </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <DisplayField label="Contact Name" value="Jasse De Lavada" />
              <DisplayField label="Phone Number" value="074XX4578" />
            </div>
          </section>
